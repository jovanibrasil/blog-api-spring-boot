...
BEGIN
	IF (NOT EXISTS(SELECT post_id FROM `posts`)) then
		...
		INSERT INTO `post_tags` (`post_id`, `tag`) VALUES (LAST_INSERT_ID(), "angular");
		INSERT INTO `posts`
			(`body`, `creation_date`, `last_update_date`, `summary`, `title`, `user_id`)
			VALUES
		...
		INSERT INTO `post_tags` (`post_id`, `tag`) VALUES (LAST_INSERT_ID(), "docker");
		INSERT INTO `posts`
			(`body`, `creation_date`, `last_update_date`, `summary`, `title`, `user_id`)
			VALUES
		...
		INSERT INTO `post_tags` (`post_id`, `tag`) VALUES (LAST_INSERT_ID(), "java");
		INSERT INTO `posts`
			(`body`, `creation_date`, `last_update_date`, `summary`, `title`, `user_id`)
		...
		INSERT INTO `post_tags` (`post_id`, `tag`) VALUES (LAST_INSERT_ID(), "others");
		INSERT INTO `posts`
			(`body`, `creation_date`, `last_update_date`, `summary`, `title`, `user_id`)
		...
		INSERT INTO `post_tags` (`post_id`, `tag`) VALUES (LAST_INSERT_ID(), "ai");
	END IF;
END $$
DELIMITER ;
